<x-baranggay-dashboard-layout>
    ...
    <section class="flex items-center justify-center w-full h-screen">
        <form action="/baranggay-admin/birhtday-cash-gift/update-status/{{$person->id}}" method="POST" class="border-gray-300 border-2 p-5 rounded-lg bg-white shadow-lg flex flex-col gap-5" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <a href="/baranggay-admin/events-programs/birthday-cash-gifts" class="w-full p-2 rounded-lg text-xs bg-red-700 text-center text-white">Back</a>
            </div>
        </form>
    </section>
</x-dashboard-layout>