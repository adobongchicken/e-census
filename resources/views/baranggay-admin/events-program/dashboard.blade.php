    ...
    <main class="flex items-start">
        <section class="w-[53%] py-5 flex flex-col gap-3 px-10">
            <article class="w-full flex items-center justify-end">
                <a href="/baranggay-admin/events-programs/event/create" class="flex items-center justify-center normal-button shadow-lg border border-gray-300 gap-x-2 font-medium py-1">
                    Add Event 
        ...
        <section class="flex-1">
            <aside class="w-full bg-red-700 p-4 flex items-center justify-between">
                ...
                <article class="flex items-center gap-x-2">
                    <form action="/baranggay-admin/events-programs" method="GET" class="relative p-2 w-fit">
                    ...
                    <form action="/baranggay-admin/events-programs" method="GET">
                            ...
                            @foreach ($listOfEvents as $event)
                                ...
                                <tr>
                                    <td class="text-xs text-center">
                                        <a href="/baranggay-admin/events-programs/event/{{ $event->id }}/view" class="hover:underline">{{ $event->program_name }}</a>
                                    </td>
