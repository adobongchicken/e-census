...
<body>
    <header class="w-full bg-red-700 p-4 flex items-center">
        <div class="flex items-center gap-2">
            <article class="relative bg-white p-2 rounded-lg">
                <a href="/baranggay-admin/events-programs"><img src="{{ asset('assets/left.png')}} " alt="Back Image" class="w-8"></a>
            </article>
    ...
    @endif
    <form method="POST" action="/event/store" class="p-5 px-32" enctype="multipart/form-data">
        @csrf
        @if ($errors->any())
