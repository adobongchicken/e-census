...
<body>
<header class="w-full bg-red-600 flex items-center justify-between sticky top-0 z-50">
...
<section class="p-8 bg-white shadow-lg border-gray-200 border-2 rounded-lg">
    <div class="flex flex-wrap justify-between gap-4">
        <article class="border-red-500 border-2 rounded-md w-full sm:w-[48%] md:w-[24%] flex items-center justify-center h-64">
            {!! $sexChart->container() !!}
        </article>
