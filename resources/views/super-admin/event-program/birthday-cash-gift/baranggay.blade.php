                    ...
                    <tbody>
                        @foreach ($persons as $person)
                            <tr>
                                ...
                                <td class="text-center text-sm"><a href="{{route('cashGifts.updateForm.super-admin', ['baranggay' => $barangay->id, 'personWithDisability' => $person->id])}}" class="hover:underline">{{ $person->first_name }} {{ $person->last_name }}</a></td>
