    ...
    <header class="w-full relative">
        <article class="w-full bg-blue-800 flex items-center justify-between px-2 pr-10 p-3">
            ...
            <div class="flex items-center gap-2">
                <a href="/birthday-cash-gift/barangay/report/{{auth()->user()->baranggay->id}}" class="normal-button">Download Reports</a>
    ...
    <main class="p-5">
        <section class="w-full">
            <div class="bg-blue-800 p-3 flex justify-between">
                ...
                <a href="/birthday-cash-gift/barangay/celebrant/{{auth()->user()->baranggay->id}}" class="normal-button">Download List</a>
            </div>
            <div class="flex items-center justify-between bg-blue-400 p-3">
                <form action="/fieldworker/events-programs/birthday-cash-gifts" method="GET" class="relative p-2 w-fit">
                ...
                <form action="/fieldworker/events-programs/birthday-cash-gifts" method="GET">
