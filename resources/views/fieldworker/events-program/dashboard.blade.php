            ...
            <section class="p-3 flex flex-col gap-5">
                @if ($todayEvents->count() > 0)
                    @foreach ($todayEvents as $event)
                        <article class="flex flex-col gap-1 {{ $todayEvents->count() > 1 ? 'border-b border-red-700 pb-3' : ''}} ">
    ...
    <main class="flex items-start">
        <section class="w-[53%] py-5 flex flex-col gap-3 px-10">
            <article class="w-full flex items-center justify-end">
                <a href="/fieldworker/events-programs/event/create"
        ...
        <section class="flex-1">
            <aside class="w-full bg-red-700 p-4 flex items-center justify-between">
                ...
                <article class="flex items-center gap-x-2">
                    <form action="/fieldworker/events-programs" method="GET" class="relative p-2 w-fit">
                    ...
                    <form action="/fieldworker/events-programs" method="GET">
                            ...
                            @foreach ($listOfEvents as $event)
                                ...
                                <tr>
                                    <td class="text-xs text-center">
                                        <a href="/fieldworker/events-programs/{{ $event->id }}/view" class="hover:underline">{{ $event->program_name }}</a>
                                    </td>
