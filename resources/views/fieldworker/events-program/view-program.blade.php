            ...
            <header class="w-full flex items-center justify-between bg-blue-800 p-3">
                <div class="flex items-center gap-2">
                    <article class="relative bg-white p-2 rounded-lg">
                        <a href="/fieldworker/events-programs"><img src="{{ asset('assets/left.png')}} " alt="Back Image" class="w-5"></a>
                    </article>
                ...
                <article class="flex flex-col gap-3">
                    <a href="/fieldworker/events-programs/{{ $program->id }}/edit"><img src="{{ asset('assets/pencil.png') }}" alt="Edit Image" class="w-7 bg-white p-[7px] rounded-lg"></a>
                    <a href="/program/pdf/{{ $program->id }}"><img src="{{ asset('assets/download.png') }}" alt="Download Image" class="w-7 bg-white p-[7px] rounded-lg"></a>
                </article>
            </header>

            <form action="/fieldworker/events-programs/{{ $program->id }}/program-report"  class="flex">
        ...
        <section class="flex flex-col items-start flex-1 ">
            <header class="w-full flex flex-col bg-red-700 p-[10px]">
                ...
                <article class="flex items-center justify-between">
                    <form action="/fieldworker/events-programs/{{ $program->id }}/view" method="GET" class="relative p-2 w-fit">
                    ...
                    <form action="/fieldworker/events-programs/{{ $program->id }}/view" method="GET">
            ...
            <aside class="w-full p-5">
                ...
                <article class="flex items-center justify-center mb-5">
                    <form action="/fieldworker/events-programs/program/invitation" method="POST" class="w-full">
                        @csrf
                ...
                <form action="/field-worker/attendance/store" method="POST" id="attendanceForm" >
                    @csrf
